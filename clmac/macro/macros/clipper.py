#! /usr/bin/env python3
"""when activated will periodically check if any new items have been added to the clipboard and add them to a list
when the user ends the program by pressing esc all the collected clipboard items will be added to the clipboard"""
