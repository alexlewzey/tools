...
ENCODINGS = [
    ...
    MacroEncoding(cat='writer', name='transaction_date', encoding=';dt', func=typer('transaction_date')),
    ...
    MacroEncoding(cat='writer', name='value_counts', encoding=';vc', func=typer('.value_counts_pct()')),
    ...
    MacroEncoding(cat='writer', name='limit_20', encoding=';ll', func=typer('limit 20')),
    ...
    MacroEncoding(cat='writer', name="n_request", encoding=';nr', func=typer("n_request")),
    # numkey writers 0
    ...
    MacroEncoding(cat='app', name='git_commit', encoding=';gc', func=writers.git_commit),
    MacroEncoding(cat='app', name='git_push', encoding=';gp', func=writers.git_push),
    ...
    MacroEncoding(cat='formatter', name='fmt_slug', encoding=';sg', func=formatters.fmt_as_slug),
    MacroEncoding(cat='formatter', name='fmt_slugs', encoding=';ss', func=formatters.fmt_as_slugs),
    ...
    MacroEncoding(cat='formatter', name='fmt_seq_as_list', encoding=';sq', func=formatters.seq2list),
