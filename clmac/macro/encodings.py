...
ENCODINGS = [
    # personal info
    MacroEncoding(
        cat="personal", name="hotmail", encoding=";hm", func=load_and_type("hotmail")
    ),
    MacroEncoding(
        cat="personal", name="gmail", encoding=";gm", func=load_and_type("gmail")
    ),
    MacroEncoding(
        cat="personal",
        name="work_email",
    ...
    MacroEncoding(
        cat="personal", name="name", encoding=";al", func=load_and_type("name")
    ),
    MacroEncoding(
        cat="personal", name="mobile", encoding=";mb", func=load_and_type("mobile")
    ),
    MacroEncoding(
        cat="personal", name="username", encoding=";un", func=load_and_type("username")
    ),
    MacroEncoding(
    ...
    MacroEncoding(
        cat="writer",
        name="Thanks for you email",
        encoding=";tf",
        func=typer("Thanks for your email. "),
    ),
    MacroEncoding(
        cat="writer",
        name="Any help would be",
        encoding=";ah",
        func=typer(boilerplate.any_help),
    ),
    MacroEncoding(
        cat="writer",
        name="Please let me know queries",
        encoding=";pl",
    ...
    MacroEncoding(
        cat="writer", name="reset_index", encoding=";ri", func=typer(".reset_index()")
    ),
    MacroEncoding(
    ...
    MacroEncoding(
        ...
        encoding=";tt",
        func=typer(boilerplate.train_test_split),
    ),
    MacroEncoding(
        cat="writer",
        name="conda activate",
    ...
    MacroEncoding(
        cat="writer", name="ascending", encoding=";as", func=typer("ascending=False")
    ),
    MacroEncoding(
        cat="writer",
    ...
    MacroEncoding(
        cat="writer", name="DataFrame", encoding=";df", func=typer("DataFrame")
    ),
    MacroEncoding(
        cat="writer",
        name="if __name__",
    ...
    MacroEncoding(
        cat="writer", name="__init__", encoding=";ii", func=typer("def __init__")
    ),
    MacroEncoding(
        cat="writer", name="type_print", encoding=";;;", func=writers.write_print
    ),
    MacroEncoding(
        cat="writer", name=".columns", encoding=";;c", func=typer(".columns")
    ),
    MacroEncoding(
        cat="writer", name="logging", encoding=";lg", func=typer(boilerplate.logger)
    ),
    MacroEncoding(
        cat="writer",
        name="log_config",
    ...
    MacroEncoding(
        ...
        name="super().__init__()",
        encoding=";su",
        func=typer("super().__init__()"),
    ),
    MacroEncoding(
        cat="writer",
        name="modules_data_sci",
        encoding=";ds",
        func=typer(boilerplate.data_sci),
    ),
    MacroEncoding(
        cat="writer",
        name="modules_deep_learning",
        encoding=";dl",
        func=typer(boilerplate.deep_learning),
    ),
    MacroEncoding(
        cat="writer",
        name="iris_dataset",
        encoding=";is",
        func=typer(boilerplate.iris_dataset),
    ),
    MacroEncoding(
        cat="writer", name="months", encoding=";mh", func=typer(boilerplate.months)
    ),
    MacroEncoding(
        cat="writer",
        name="months_abbr",
        encoding=";ma",
        func=typer(boilerplate.months_abbr),
    ),
    MacroEncoding(
        cat="writer", name="df_columns", encoding=";cn", func=writers.type_columns
    ),
    MacroEncoding(
        cat="writer",
        name=".sort_values()",
    ...
    MacroEncoding(
        ...
        name="n_pct",
        encoding=";np",
        func=typer("COUNT(*) n, COUNT(*) / sum(COUNT(*)) over () pct"),
    ),
    MacroEncoding(
        cat="writer",
        name="memory_usage",
    ...
    MacroEncoding(
        cat="writer", name=": -> None:", encoding=";tn", func=typer(" -> None:")
    ),
    MacroEncoding(
        cat="writer", name="select_from", encoding=";sf", func=typer("select * from ")
    ),
    MacroEncoding(
        cat="writer",
        name=r"select_\n_from",
    ...
    MacroEncoding(
        cat="writer",
        name="select_from_upper",
        encoding=";SF",
        func=typer("select * \nfrom "),
    ),
    MacroEncoding(
        cat="writer", name="left join", encoding=";lj", func=typer("left join")
    ),
    MacroEncoding(
        cat="writer",
        name="limit_20",
    ...
    MacroEncoding(
        ...
        encoding=";cr",
        func=typer("create or replace table "),
    ),
    MacroEncoding(
        cat="writer",
        name="sql_duplicates",
    ...
    MacroEncoding(
        cat="writer", name="distribution", encoding=";dn", func=typer("distribution")
    ),
    MacroEncoding(
        cat="writer", name="primary_key", encoding=";pk", func=typer("primary_key=")
    ),
    MacroEncoding(
        cat="writer",
        name="auto_open",
        encoding=";ao",
        func=typer("AUTO_OPEN: bool = False"),
    ),
    MacroEncoding(
        cat="writer",
        name=".query(f" ")",
        encoding=";qy",
        func=typer(""".query(f'')""", 2),
    ),
    MacroEncoding(
        cat="writer", name="n_customer", encoding=";nc", func=typer("n_customer")
    ),
    MacroEncoding(
        cat="writer", name="n_transaction", encoding=";nt", func=typer("n_transaction")
    ),
    MacroEncoding(
        cat="writer",
        name=".iloc[:25, :25]",
        encoding=";il",
        func=typer(".iloc[:25, :25]"),
    ),
    MacroEncoding(
        cat="writer",
        name="data scientist",
        encoding=";dd",
        func=typer("Data Scientist"),
    ),
    MacroEncoding(
        cat="writer",
        name="subplots",
        encoding=";sp",
        func=typer("fig, ax = plt.subplots()"),
    ),
    MacroEncoding(
        cat="writer",
        name="rename",
        encoding=";rn",
        func=typer(".rename({}, axis=1)", 10),
    ),
    ...
    MacroEncoding(
        cat="writer", name="deactivate", encoding=";da", func=typer("deactivate")
    ),
    MacroEncoding(
        cat="writer", name="minute_dt", encoding=";md", func=typer("minute_dt")
    ),
    MacroEncoding(
        cat="writer", name=".toPandas()", encoding=";tp", func=typer(".toPandas()")
    ),
    MacroEncoding(
        cat="writer",
        name="agg_request",
    ...
    MacroEncoding(
        cat="numkeys", name="2", encoding=";22", func=load_and_type_numkey_1(2)
    ),
    MacroEncoding(
        cat="numkeys", name="3", encoding=";33", func=load_and_type_numkey_1(3)
    ),
    MacroEncoding(
        cat="numkeys", name="4", encoding=";44", func=load_and_type_numkey_1(4)
    ),
    MacroEncoding(
        cat="numkeys", name="5", encoding=";55", func=load_and_type_numkey_1(5)
    ),
    MacroEncoding(
        cat="numkeys", name="6", encoding=";66", func=load_and_type_numkey_1(6)
    ),
    MacroEncoding(
        cat="numkeys", name="7", encoding=";77", func=load_and_type_numkey_1(7)
    ),
    MacroEncoding(
        cat="numkeys", name="8", encoding=";88", func=load_and_type_numkey_1(8)
    ),
    MacroEncoding(
        cat="numkeys", name="9", encoding=";99", func=load_and_type_numkey_1(9)
    ),
    # run script
    MacroEncoding(cat="app", name="img2text", encoding=";i2", func=img2text.img2text),
    MacroEncoding(
        cat="app", name="clipboard2browser", encoding=";cb", func=clipboard2browser
    ),
    MacroEncoding(cat="app", name="clipper", encoding=";cl", func=clipper.run),
    MacroEncoding(
        cat="app",
        name="caret_to_line_start",
        encoding=";ls",
        func=writers.caret_to_line_start,
    ),
    MacroEncoding(
        cat="app",
        name="caret_to_line_end",
        encoding=";le",
    ...
    MacroEncoding(
        cat="app", name="morning_sites", encoding=";ms", func=launchers.morning_sites
    ),
    # formatting scripts
    # MacroEncoding(cat='formatter', name='wrap_str', encoding=';;t', func=partial(formatters.wrap_cb, prefix='str')),
    MacroEncoding(
        cat="formatter", name="-- TEST: ", encoding=";;t", func=typer("-- TEST: ")
    ),
    MacroEncoding(
        cat="formatter",
        name="unnest_paraenthesis",
        encoding=";up",
    ...
    MacroEncoding(
        ...
        name="wrap_fstring",
        encoding=";ff",
        func=formatters.wrap_clipboard_in_fstring,
    ),
    MacroEncoding(
        cat="formatter",
        name="select_line_at_caret",
        encoding=";sl",
        func=formatters.line_at_caret_to_cb,
    ),
    MacroEncoding(
        cat="formatter",
        name="select_word_at_caret",
        encoding=";sw",
        func=formatters.word_at_caret_to_cb,
    ),
    MacroEncoding(
        cat="formatter",
        name="cut_right_equality",
        encoding=";re",
        func=formatters.cut_right_equality,
    ),
    MacroEncoding(
        cat="formatter",
        name="set_equal_to_self",
        encoding=";se",
        func=formatters.set_equal_to_self,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_pycharm_params",
        encoding=";pc",
        func=formatters.fmt_pycharm_params,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_class_props_multiline",
        encoding=";cp",
        func=formatters.fmt_class_properties_multiline,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_class_props_multiassign",
        encoding=";cm",
        func=formatters.fmt_class_properties_multiassign,
    ),
    MacroEncoding(
    ...
    MacroEncoding(
        cat="formatter",
        name="fmt_hash_center",
        encoding=";hc",
        func=formatters.fmt_hash_center,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_rm_whitespace",
        encoding=";rw",
        func=formatters.rm_doublespace,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_rm_blanklines",
        encoding=";rb",
    ...
    MacroEncoding(
        cat="formatter", name="fmt_seq_as_list", encoding=";tl", func=formatters.to_list
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_as_multiple_lines",
        encoding=";ml",
        func=formatters.fmt_as_multiple_lines,
    ),
    MacroEncoding(
        cat="formatter",
        name="fmt_params_as_multiline",
        encoding=";pm",
        func=formatters.fmt_params_as_multiline,
    ),
    MacroEncoding(
        cat="formatter", name="fmt_as_pipe", encoding=";pe", func=formatters.fmt_as_pipe
    ),
    MacroEncoding(
        cat="formatter",
    ...
    MacroEncoding(
        ...
        name="parse_sql_table",
        encoding=";sq",
        func=formatters.swap_quotation_marks,
    ),
    MacroEncoding(
        cat="formatter",
        name="camel_to_snake",
    ...
    MacroEncoding(
        ...
        name="fmt_variables",
        encoding=";fv",
        func=formatters.fmt_print_variables,
    ),
    MacroEncoding(
        cat="formatter",
    ...
    MacroEncoding(
        ...
        name="select_prev_1",
        encoding=";s1",
        func=partial(typer.select_previous_lines, n_lines=1),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_2",
        encoding=";s2",
        func=partial(typer.select_previous_lines, n_lines=2),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_3",
        encoding=";s3",
        func=partial(typer.select_previous_lines, n_lines=3),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_4",
        encoding=";s4",
        func=partial(typer.select_previous_lines, n_lines=4),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_5",
        encoding=";s5",
        func=partial(typer.select_previous_lines, n_lines=5),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_6",
        encoding=";s6",
        func=partial(typer.select_previous_lines, n_lines=6),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_7",
        encoding=";s7",
        func=partial(typer.select_previous_lines, n_lines=7),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_8",
        encoding=";s8",
        func=partial(typer.select_previous_lines, n_lines=8),
    ),
    MacroEncoding(
        cat="line select",
        name="select_prev_9",
        encoding=";s9",
        func=partial(typer.select_previous_lines, n_lines=9),
    ),
]
...
t = ['alsdjkfasdlkj', 'asldkfjasldkjf', 'alsdkfjalksdjf', 'alskdfjalsdkjfasd', 'ajksldfjasldkfjas', 'aalsdkfjalskdjf', 'alsdkfjaslkdjf']